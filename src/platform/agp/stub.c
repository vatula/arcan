...
void agp_setenv(struct agp_fenv* fenv)
{
}

void agp_dropenv(struct agp_fenv* fenv)
{
}
...
void agp_stream_release(struct agp_vstore* s, struct stream_meta m)
{
}

void agp_stream_commit(struct agp_vstore* s, struct stream_meta m)
{
}

bool agp_slice_vstore(struct agp_vstore* backing,
	size_t n_slices, size_t base_size, enum txstate state)
{
	return false;
}
...
struct agp_rendertarget* agp_setup_rendertarget(
	struct agp_vstore* dst, enum rendertarget_mode mode)
{
	return NULL;
}
...
void agp_resize_rendertarget(struct agp_rendertarget* tgt,
